        ...
        serviceApi: (function () {
            return {
                ...
                getPayStatisticByClass: function () {
                    applicationServiceSet.chargeServiceApi.chargeService.GetPayStatisticByClass.send([APPMODEL.Storage.getItem('copPage_token'), $scope.pagination.itemsPerPage, $scope.pagination.currentPage,APPMODEL.Storage.getItem("orgid"),$scope.queryFields.selectedGid, $scope.model.province, $scope.model.city, $scope.model.county, $scope.model.selectProductPackageID,$scope.model.openProductId,paymentBySchoolStatistics.dateChange($scope.model.dateStart),paymentBySchoolStatistics.dateChange($scope.model.dateOver)]).then(function (data) {
                        if (data.Ret == 0) {
            ...
            return {
                ...
                basic: function () {
                    ...
                    $scope.export = function () {
                        $window.location.href = urlConfig + 'Charge/v3/ChargeManage/ExportStatisticByClass' + '?token=' + APPMODEL.Storage.getItem("copPage_token") + '&orgid=' + APPMODEL.Storage.getItem("orgid") + '&gid=' + $scope.queryFields.selectedGid + '&ProvinceId=' + $scope.model.province + '&CityId=' + $scope.model.city + '&CountyId=' + $scope.model.county + '&productId='+$scope.model.selectProductPackageID+'&chargeId='+$scope.model.openProductId+'&sDate=' + paymentBySchoolStatistics.dateChange($scope.model.dateStart) + '&eDate=' + paymentBySchoolStatistics.dateChange($scope.model.dateOver);
                    };
