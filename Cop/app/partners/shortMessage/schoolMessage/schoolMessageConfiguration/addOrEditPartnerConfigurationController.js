 ...
 * addOrEditPartnerConfigurationController
 * add or edit configuration
 */
app.controller('addOrEditPartnerConfigurationController', ['$scope', '$http', '$state', '$stateParams', '$timeout', '$location', '$rootScope', 'applicationServiceSet', 'toastr', function ($scope, $http, $state, $stateParams, $timeout, $location, $rootScope, applicationServiceSet, toastr) {
    /**
     * add or edit configuration
     */
