        ...
        serviceApi: (function () {
            return {
                ...
                getSimpleOrgUsers: function () {
                    applicationServiceSet.internalServiceApi.userManagement.GetOrgAdmin.send([APPMODEL.Storage.getItem('copPage_token'), APPMODEL.Storage.getItem("orgid"),2]).then(function (data) {
                        if (data.Ret == 0) {
                ...
                addOrgUser: function (item, func) {
                    applicationServiceSet.internalServiceApi.userManagementInstitution.AddOrgUserNew.send([item.OrgID, item.UID,2], [APPMODEL.Storage.getItem('copPage_token')]).then(function (data) {
                        if (data.Ret == 0) {
