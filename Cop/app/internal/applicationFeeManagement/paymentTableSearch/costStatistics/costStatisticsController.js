 ...
 */
app.controller('costStatisticsController', ['$scope', '$http', '$state', '$stateParams', '$timeout', '$location', '$rootScope', '$window', 'toastr', '$modal', 'applicationServiceSet', function ($scope, $http, $state, $stateParams, $timeout, $location, $rootScope, $window, toastr, $modal, applicationServiceSet) {
    /**
    ...
    var paymentBySchoolStatistics = {
        ...
        serviceApi: (function () {
            return {
                 ...
                 */
                getPayStatisticByClass: function () {
                    applicationServiceSet.chargeServiceApi.chargeService.GetPayStatisticByClass.send([APPMODEL.Storage.getItem('copPage_token'), $scope.pagination.itemsPerPage, $scope.pagination.currentPage,$scope.model.partners,$scope.queryFields.selectedGid, $scope.model.province, $scope.model.city, $scope.model.county, $scope.model.selectProductPackageID,$scope.model.openProductId,paymentBySchoolStatistics.operation.dateChange($scope.model.dateStart),paymentBySchoolStatistics.operation.dateChange($scope.model.dateOver)]).then(function (data) {
                        if (data.Ret == 0) {
