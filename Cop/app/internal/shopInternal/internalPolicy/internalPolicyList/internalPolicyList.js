    ...
    var internalPolicyList = {
        ...
        operation: function () {
            ...
            $scope.createRlue=function (item) {
                ...
                $location.url('access/app/internal/internalPolicy/listOfRegulation?sid='+item.ID+'&sName=' +item.Name+'&type='+item.SType);
            }
            //生效角色
            $scope.createEffctRole=function (item) {
                $location.url('access/app/internal/internalPolicy/listOfEffectiveRoleAll?sid='+item.ID+'&sName=' +item.Name);
            }
