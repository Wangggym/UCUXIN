    ...
    var trafficClass ={
        ...
        operation: function () {
            ...
            $scope.toUsers = function (cid,GName) {
                ...
                $location.url('access/app/internal/afterManage/trafficUser?year='+$scope.model.hisYear+'&month='+$scope.model.hisMonth+'&schoolID='+$stateParams.school+'&classID='+cid+'&name='+$stateParams.name+GName);
            }
        }
    }
    trafficClass.init();
