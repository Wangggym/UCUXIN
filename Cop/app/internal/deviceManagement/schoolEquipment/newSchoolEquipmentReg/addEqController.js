    ...
    var EC = {
        ...
        basic:function () {
            ...
            $scope.selectEqId = function (id) {
                EC.getEqArgument(id);
                var curEq = $scope.model.eqList.filter(function (e, i) {
                    return e.ID == id;
                });
                $scope.model.curEq = curEq[0];
            };
            //返回
            $scope.back = function () {
...
app.controller('newAddEq', ['$scope', '$modalInstance', 'item', function ($scope, $modalInstance, item) {
