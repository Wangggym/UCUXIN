        ...
        service: (function () {
            return {
                ...
                getTestTask: function () {
                    applicationServiceSet.internalServiceApi.nutritionHealth.GetTestTask.send([APPMODEL.Storage.getItem('copPage_token'), $scope.model.selectedGid, $scope.model.isSchool, $scope.model.name, $scope.model.statusI, $scope.model.pSize, $scope.model.pIndex]).then(function (data) {
                        if (data.Ret == 0) {
