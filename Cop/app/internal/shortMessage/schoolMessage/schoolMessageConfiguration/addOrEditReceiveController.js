 ...
 * addOrEditReceiveController
 * add or edit receive controller
 */
app.controller('addOrEditReceiveController', ['$scope', '$http', '$state', '$stateParams', '$timeout', '$location', '$rootScope', 'applicationServiceSet', 'toastr', '$modal', function ($scope, $http, $state, $stateParams, $timeout, $location, $rootScope, applicationServiceSet, toastr, $modal) {
  /**
   * add or edit receive
   */
  var addOrEditReceive = (function () {
    ...
    /**
     * service set
     * @type {{getOrgSchoolPage: getOrgSchoolPage, saveInfoSmsSendRulesForTopGrp: saveInfoSmsSendRulesForTopGrp, getMembers: getMembers, getInfoSmsRvRulesByTopGrp: getInfoSmsRvRulesByTopGrp}}
     */
    var serviceApi = {
      /**
