 ...
 */
app.controller('WholeNetworkBannerSetController', ['$scope', 'toastr', '$location', '$modal', 'applicationServiceSet', '$window', function ($scope, toastr, $location, $modal, applicationServiceSet, $window) {
    'use strict';
