...
app.controller('trafficSchool', ['$scope', '$http', '$state', '$stateParams', '$timeout', '$location', '$rootScope', '$window', 'toastr', '$modal', 'applicationServiceSet', function ($scope, $http, $state, $stateParams, $timeout, $location, $rootScope, $window, toastr, $modal, applicationServiceSet) {
    ...
    var trafficSchool = {
            ...
            return {
                ...
                GetSchoolFlowDetlList: function () {
                    ...
                    if($scope.model.initDate){
                        $scope.GetSchoolData.Year = $stateParams.year;
                        $scope.GetSchoolData.Month = $stateParams.month;
        ...
        operation: function () {
            ...
            //跳转到
            $scope.toClass = function (gid,GName,grpType) {
                if(grpType == true){
                    $location.url('access/app/internal/UXLive/trafficClass?year='+$scope.model.hisYear+'&month='+$scope.model.hisMonth+'&school='+gid+'&name='+GName+'&PtnID='+$stateParams.PtnID);
                }else{
                    $location.url('access/app/internal/UXLive/trafficUser?year='+$scope.model.hisYear+'&month='+$scope.model.hisMonth+'&schoolID='+gid+'&name='+GName+'&PtnID='+$stateParams.PtnID);
                }
