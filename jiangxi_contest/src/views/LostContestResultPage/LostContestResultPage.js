...
import fusai from '../../assets/images/决赛.png'
import touxiang from '../../assets/images/微信图片_20171114162919.jpg'

class LostContestResultPage extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            hasResult: true,
    ...
    render() {
        ...
        return (
            <div className="LostContestResultPage">
                {!hasResult && <NoContent>
...
export default LostContestResultPage