...
class FilesUpload extends Component {
  ...
  handleUpload = (fn)=>{
     this.props.form.validateFields((err, values) => fn(err, values));
  }
    ...
    return (
      <div className="resource-list">
        <Form className="form-search-group" style={{marginBottom: '15px'}}>
          ...
          {/* 文件上传 */}
          <TextFile className="line" onUpload={this.handleUpload} onCancel={this.handleCancel} {...this.props} tags={tags}/>
        </Form>
      </div>
    );
  }
