...
class MyCourse extends React.Component {
    ...
    handleClick = (ID) => {
        setTimeout(() => this.props.history.push({ pathname: `/train-course/${ID}` }), 200)
    }
        ...
        return (
            <div className='my-course' ref="container">
                <Popover
                    ...
                    overlay={[
                        (<Item key="4" value="scan"><CollectButton ID={this.props.ID} onClick={() => this.props.onRefresh()} favorType={1}/></Item>),
                    ]}
                    align={{
...
export default LongListWrappedComp(trainPlan.getMyFavorPlanPage)(withRouter(MyCourse))
