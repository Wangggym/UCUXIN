...
class InsertTopicGoods extends Component{
  ...
  constructor(props){
    ...
    this.state = {
      ...
      Keyword:'',
      data:{ContentType:25,ContentID:1,Title:null,Thumb:null,Img:null,Url:null,Desc:null,SalePrice:null},
    };
    this.colums = [
      {
        title: '商品名称',
  ...
  componentWillReceiveProps(nextProps) {
    if(nextProps.dataClean && nextProps.dataClean !== this.props.dataClean){
      ...
      this.setState({data:{ContentType:25,ContentID:1,Title:null,Thumb:null,Img:null,Url:null,SalePrice:null}})
    }
  }
...
export default Form.create()(InsertTopicGoods);