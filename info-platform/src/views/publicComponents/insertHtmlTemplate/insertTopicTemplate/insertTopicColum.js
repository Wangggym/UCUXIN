...
class InsertTopicColum extends Component{
  ...
  constructor(props){
    ...
    this.state = {
      ...
      Keyword:'',
      data:{ContentType:21,ContentID:1,Title:null,Thumb:null,Img:null,Url:null,Desc:null},
    };
    this.colums = [
      {
        title: '专栏名称',
          ...
          <FormItem  {...formItemLayout}>
            {getFieldDecorator('search', {
              ...
              <Search
                placeholder="请搜索专栏标题"
                onSearch={value => {
                  this.setState({Keyword: value}, () => {this.getScolumnList(pagination.current);});
                }}
              />
            )}
          </FormItem>
...
export default Form.create()(InsertTopicColum);